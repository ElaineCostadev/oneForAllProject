...
CREATE TABLE SpotifyClone.Seguindo_Artistas(
    seguindo_artistas INT AUTO_INCREMENT,
    artista_id INT NOT NULL,
    usuario_nome_id INT NOT NULL,
    criado_em TIMESTAMP DEFAULT NOW(),
    CONSTRAINT PRIMARY KEY (seguindo_artistas, artista_id, usuario_nome_id),
...
CREATE TABLE SpotifyClone.Reproducoes(
    cancoes_musica_id INT NOT NULL,
    usuario_nome_id INT NOT NULL,
    data_reproducao TIMESTAMP NOT NULL,
    criado_em TIMESTAMP DEFAULT NOW(),
    CONSTRAINT PRIMARY KEY (cancoes_musica_id, usuario_nome_id),
    FOREIGN KEY (cancoes_musica_id) REFERENCES Cancoes (musica_id),
    FOREIGN KEY (usuario_nome_id) REFERENCES Usuario (usuario_id)
) engine=InnoDB;

INSERT INTO Plano (tipo, valor_plano) VALUES ('gratuito', 0.00), ('familiar', 7.99), ('universitário', 5.99), ('pessoal', 6.99);

INSERT INTO Usuario (nome, idade, data_assinatura, plano_id) VALUES
('Thati', 23, '2019-10-20', 1), ('Cintia', 35, '2017-12-30', 2), ('Bill', 20, '2019-06-05', 3), ('Roger', 45, '2020-05-13', 4), ('Norman', 58, '2017-02-17', 4), ('Patrick', 33, '2017-01-06', 2), ('Vivian', 26, '2018-01-05', 3), ('Carol', 19, '2018-02-14', 3), ('Angelina', 42, '2018-04-29', 2),('Paul', 46, '2017-01-17', 2);
...
INSERT INTO Reproducoes (cancoes_musica_id, usuario_nome_id, data_reproducao) VALUES (36, 1, "2020-02-28 10:45:55"),
(25, 1, "2020-05-02 05:30:35"), (23, 1, "2020-03-06 11:22:33"), (14, 1, "2020-08-05 08:05:17"), (15, 1, "2020-09-14 16:32:22"), (34, 2, "2020-01-02 07:40:33"), (24, 2, "2020-05-16 06:16:22"),(21, 2,  "2020-10-09 12:27:48"), (39, 2,  "2020-09-21 13:14:46"), (6, 3, "2020-11-13 16:55:13"),(3, 3,  "2020-12-05 18:38:30"), (26, 3, "2020-07-30 10:00:00"),(2, 4, "2021-08-15 17:10:10"), (35, 4, "2021-07-10 15:20:30"), (27, 4,  "2021-01-09 01:44:33"), (7, 5, "2020-07-03 19:33:28"), (12, 5, "2017-02-24 21:14:22"), (14, 5, "2020-08-06 15:23:43"), (1, 5,  "2020-11-10 13:52:27"), (38, 6, "2019-02-07 20:33:48"), (29, 6, "2017-01-24 00:31:17"), (30, 6, "2017-10-12 12:35:20"), (22, 6,  "2018-05-29 14:56:41"), (5, 7, "2018-05-09 22:30:49"), (4, 7, "2020-07-27 12:52:58"), (11, 7, "2018-01-16 18:40:43"), (39, 8, "2018-03-21 16:56:40"), (40, 8, "2020-10-18 13:38:05"), (32, 8, "2019-05-25 08:14:03"), (33, 8, "2021-08-15 21:37:09"), (16, 9, "2021-05-24 17:23:45"), (17, 9, "2018-12-07 22:48:52"), (8, 9, "2021-03-14 06:14:26"), (9, 9, "2020-04-01 03:36:00"), (20, 10, "2017-02-06 08:21:34"), (21, 10, "2017-12-04 05:33:43"), (12, 10,  "2017-07-27 05:24:49"), (13, 10, "2017-12-25 01:03:57");
